...
export default function Pointer({ label, colour, className }: PointerProps) {
  return (
    <div
      className={twMerge(
        "flex items-center gap-2 select-none pointer-events-none relative",
        className
      )}
    >
      <svg
      ...
      <span
        className="absolute top-4.5 left-4.5 text-sm px-2 py-[1px] rounded-tl-sm rounded-xl z-10"
